...
Var noggrann vid sökning efter Agenten och länka om möjligt. Vid behov skapa ny Agent. Använd de mallar som finns vid Skapa ny - Agent tillsammans med de hjälptexter för Agenter som finns i Hjälpsektion. I undantagsfall, skapas olänkad agent enligt nedan.

Enligt Riktlinjer för det löpande auktoritetsarbetet i Libris skapas inte alltid auktoritetsposter, se [Riktlinjer för det löpande auktoritetsarbetet i Libris](http://www.kb.se/dokument/Riktlinjer%20för%20det%20löpande%20auktoritetsarbetet%20i%20Libris.pdf). För dessa fall följ anvisningarna nedan för att skapa olika typer av olänkade agenter.
